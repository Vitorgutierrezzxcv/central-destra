    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col">
      ...
      <div className="text-white px-5 md:px-4 pt-28 md:pt-12 pb-8 md:pb-12">
        <div className="max-w-lg md:max-w-6xl mx-auto">
          ...
          <h1 className="text-xl md:text-[3.25rem] leading-[1.15] font-extralight tracking-tight mb-4">
             Todos Seus<br />Projetos
           </h1>
           <p className="text-sm md:text-sm text-slate-300 font-light leading-relaxed max-w-md">
