         ...
         <div className="flex items-end justify-between gap-4 mb-4">
           <h1 className="text-7xl md:text-6xl leading-[1.1] font-extralight text-white tracking-tight">
             ...
             <div className="text-right">
               ...
               <p className="text-[10px] text-blue-100 uppercase tracking-wider mt-0.5">pendente{pendingCount > 1 ? "s" : ""}</p>
             </div>
           )}
         </div>
       </div>
      ...
      <div className="max-w-full w-full px-5 md:px-4 pb-16">
        ...
        {isLoading ? (
          ...
          tasks.map(task => {
            ...
            return (
              <div key={task.id} className="rounded-2xl border overflow-hidden" style={{ backgroundColor: "#0D1420", borderColor: "#050D1B" }}>
                {/* Task Header */}
                ...
                {(taskDeliveries.length > 0 || canApproveTask || taskFeedback) && (
                  <div className="border-t px-5 py-4 space-y-3" style={{ borderColor: "#050D1B", backgroundColor: "#0D1420" }}>
                    {taskDeliveries.map(delivery => {
                      ...
                      return (
                        <div key={delivery.id} className="rounded-xl border p-4" style={{ backgroundColor: "#080E18", borderColor: "#050D1B" }}>
                          ...
                          {delivery.public_notes && (
                            <div className="rounded-xl p-3 mb-3 border" style={{ backgroundColor: "#050D1B", borderColor: "#020408" }}>
                            ...
                            <div className="flex flex-wrap gap-2 mb-3">
                              {delivery.attachment_urls.map((url, i) => (
                                <a key={i} href={url} target="_blank" rel="noreferrer"
                                  ...
                                  style={{ backgroundColor: "#050D1B", borderColor: "#020408", color: "#C5D1DC" }}>
                    ...
                    {canApproveTask && (
                       <div className="rounded-xl p-4 border" style={{ backgroundColor: "#080E18", borderColor: "#050D1B" }}>
                     ...
                     {taskFeedback && taskDeliveries.length === 0 && (
                       <div className="flex items-center gap-2.5 p-3 rounded-xl border text-xs font-light" style={{ backgroundColor: "#080E18", borderColor: "#050D1B", color: "#C5D1DC" }}>
