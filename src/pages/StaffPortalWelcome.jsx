...
const SLIDES = [
  { tag: "Bem-vindo à central", headline: "Gerencie\nseus projetos", sub: "em tempo real." },
  { tag: "Tarefas e entregas", headline: "Acompanhe o progresso\nde cada projeto", sub: "com sua equipe." },
  { tag: "Comunicação eficaz", headline: "Comunique-se\ncom clareza", sub: "pelo portal." },
];
...
export default function StaffPortalWelcome() {
  ...
  const doExit = () => {
    setLeaving(true);
    setTimeout(() => navigate("/StaffPortalLogin"), 300);
  };
