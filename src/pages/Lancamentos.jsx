        ...
        <div className="mb-6 md:mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-4">
            ...
            <Button 
              ...
              className="bg-[#131A20] hover:bg-[#456C8D] text-white rounded-lg h-10 md:h-11 px-6"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
          <Card className="bg-white border border-[#EAEAEA] rounded-xl">
            <CardContent className="p-4 md:p-6">
              <div className="flex items-start justify-between mb-2">
                <div className="bg-[#EAEAEA] rounded-xl p-2 md:p-3">
                  <TrendingUp className="w-5 h-5 md:w-6 md:h-6 text-[#131A20]" />
                </div>
                <div className="text-right">
                  <div className="text-2xl md:text-4xl font-semibold text-[#131A20]">
                    R$ {monthIncome.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                  </div>
                </div>
              </div>
              <p className="text-[#456C8D] font-medium text-xs md:text-sm">Entradas do Mês</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white border border-[#EAEAEA] rounded-xl">
            <CardContent className="p-4 md:p-6">
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="text-right">
                  <div className="text-2xl md:text-4xl font-semibold text-red-500">
                    R$ {monthExpense.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                  </div>
                </div>
              </div>
              <p className="text-[#456C8D] font-medium text-xs md:text-sm">Saídas do Mês</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white border border-[#EAEAEA] rounded-xl">
            <CardContent className="p-4 md:p-6">
              <div className="flex items-start justify-between mb-2">
                <div className="bg-[#EAEAEA] rounded-xl p-2 md:p-3">
                  <Wallet className="w-5 h-5 md:w-6 md:h-6 text-[#6FA6FF]" />
                </div>
                <div className="text-right">
                  <div className="text-2xl md:text-4xl font-semibold text-[#6FA6FF]">
                    R$ {(monthIncome - monthExpense).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                  </div>
                </div>
              </div>
              <p className="text-[#456C8D] font-medium text-xs md:text-sm">Saldo do Mês</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white border border-[#EAEAEA] rounded-xl">
            <CardContent className="p-4 md:p-6">
              <div className="flex items-start justify-between mb-2">
                <div className="bg-[#EAEAEA] rounded-xl p-2 md:p-3">
                  <Wallet className={`w-5 h-5 md:w-6 md:h-6 ${balance >= 0 ? 'text-[#456C8D]' : 'text-red-500'}`} />
                </div>
                <div className="text-right">
                  <div className={`text-2xl md:text-4xl font-semibold ${balance >= 0 ? 'text-[#456C8D]' : 'text-red-500'}`}>
                    R$ {balance.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                  </div>
                </div>
              </div>
              <p className="text-[#456C8D] font-medium text-xs md:text-sm">Saldo Total</p>
            </CardContent>
          </Card>
        </div>
