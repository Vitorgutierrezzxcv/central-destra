    ...
    return (
      <div className="bg-slate-900 mb-5 px-4 py-3 rounded-2xl">
        ...
        <div className="flex items-center justify-between gap-2">
          <span className="text-white font-light uppercase tracking-widest text-[10px] sm:text-xs shrink-0">POMODORO</span>
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            <span className="text-white text-lg sm:text-xl font-light tabular-nums tracking-tight min-w-[46px] text-right">
              {mins}:{secs}
            </span>
          </div>
        </div>
        ...
        <div className="flex gap-1 mt-2">
          ...
          <button
            ...
            className={`flex-1 py-1.5 rounded-lg text-[10px] sm:text-[11px] font-light transition-all ${
