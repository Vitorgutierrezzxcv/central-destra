    ...
    return (
      <div className="bg-[#131A20] rounded-2xl px-5 py-3.5 flex items-center gap-4 mb-5">
        ...
        <div className="flex items-center gap-3 flex-1 min-w-0">
          <span className="text-[#6FA6FF] text-[10px] font-light uppercase tracking-widest shrink-0">Pomodoro</span>
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <button
            ...
            className="w-8 h-8 rounded-xl flex items-center justify-center transition-all text-white"
