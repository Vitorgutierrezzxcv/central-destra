...
import { Pencil, Trash2, Circle, ArrowUpCircle, CheckCircle2, Flag, Clock, Calendar } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-slate-50">
              ...
              <TableHead className="font-bold text-slate-900 hidden md:table-cell">Tempo</TableHead>
              ...
              return (
                <React.Fragment key={task.id}>
                  <TableRow className="hover:bg-slate-50 transition-colors">
                    ...
                    <TableCell className="hidden xl:table-cell text-sm text-slate-600">
                      {task.end_date ? formatDateOnly(task.end_date) : '-'}
                    </TableCell>
